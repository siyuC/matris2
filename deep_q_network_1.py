...
ACTIONS = 44 # number of valid actions
...
def trainNetwork(s, readout, h_fc1, sess,screen):
    ...
    while 1:
        ...
        if t % 10000 == 0:
            saver.save(sess, 'saved_networks/' + 'dqn_1/', global_step = t)
            print "TIMESTEP", t, "/ LINES", game_state.lines, "/ EPSILON", epsilon,"/ EPISODE REWARD", r_episode, "/ Q_MAX %e" % np.max(readout_t)
        # print info
